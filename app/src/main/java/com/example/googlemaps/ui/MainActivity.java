...
import com.example.googlemaps.domain.preference.Preference;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    private void initPrefs() {
        ...
        if (Preference.getInstance().isPolygonUsed() && !(polygoneMarkers.isEmpty()) ){
            polygonOptions.addAll(polygoneMarkers);
            map.addPolygon(polygonOptions);
        }else if (Preference.getInstance().isPolylineUsed() && !(polylineMarkers.isEmpty())){
